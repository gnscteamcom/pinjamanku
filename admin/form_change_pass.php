<?php 
  //echo $_SESSION['role'];
	if (isset($_POST['changePass'])) {
		...
		$data=mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM admin WHERE id_admin = '".$_SESSION['userId']."'"));

		if ($data['password'] == $oldpassword) {
			if ($newpassword == $repeatnewpassword) {
				mysqli_query($con,"UPDATE admin SET password='".$newpassword."' WHERE id_admin= '".$_SESSION['userId']."' ");
