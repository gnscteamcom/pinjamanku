    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Data Detail Pinjaman</h3>
            </div>
                    ...
                    <tbody>
                       <?php
                            $SQL = "SELECT A.*, B.*, CONCAT(C.nm_depan,' ',C.nm_blkg) AS NAMA_ANGGOTA
                                    ...
                                    WHERE B.id_pinjaman = $_GET[id_pinjaman]";
                            //echo $SQL;
                            $qu=mysqli_query($con,$SQL);
                            while($has=mysqli_fetch_assoc($qu))
                            {
                                $jumlah = 'Rp. '.number_format($has['jumlah'], 2, '.', ',');
                                $denda = 'Rp. '.number_format($has['denda'], 2, '.', ',');
                                echo "
                                <tr>
                                    <td>$has[NAMA_ANGGOTA]</td>
                                    <td>$jumlah</td>
                                    <td>$has[tenor_ke]</td>
                                    <td>$has[tanggal]</td>
                                    <td>$denda</td>
                                    ...
                                    <span data-placement='top' data-toggle='tooltip' title='Update'><button onclick='dataUpdate($has[id_trans],&#39;get_network&#39;)' class='btn btn-primary btn-xs' data-title='Update' data-toggle='modal' data-target='#modalUpNetwork' ><span class='glyphicon glyphicon-pencil'></span></button><span>

                        <span data-placement='top' data-toggle='tooltip' title='Delete'><button onclick='datadel($has[id_trans],&#39;list_network&#39;)' class='btn btn-danger btn-xs' data-title='Delete' data-toggle='modal' data-target='#modalDel' ><span class='glyphicon glyphicon-trash'></span></button><span>
                                    </td>
                                </tr>
                                ";
                            }
